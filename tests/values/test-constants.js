...
const endpoints = {
  ...
  image: (name) =>
    `/v2/_zot/ext/search?query={Image(image:%20%22${name}%22){RepoName%20IsSigned%20SignatureInfo%20{%20Tool%20IsTrusted%20Author%20}%20Vulnerabilities%20{MaxSeverity%20Count}%20%20Referrers%20{MediaType%20Size%20Digest}%20Tag%20TaggedTimestamp%20ArtifactType%20Manifests%20{ArtifactType%20Layers%20{Size%20Digest}%20History%20{Layer%20{Size%20Digest}%20HistoryDescription%20{CreatedBy%20EmptyLayer}}%20Digest%20ConfigDigest%20LastUpdated%20Size%20Platform%20{Os%20Arch}%20Referrers%20{MediaType%20Size%20Digest}}%20Vendor%20Licenses%20}}`
};
